...
app.include_router(trips.router, prefix=config.api_prefix)
app.include_router(itinerary.router, prefix=config.api_prefix)
app.include_router(packing.router, prefix=config.api_prefix)
app.include_router(expenses.router, prefix=config.api_prefix)
