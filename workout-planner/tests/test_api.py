...
from core.database import init_sqlite, DATABASE_URL
import os
import sqlite3
...
def setup_test_db():
    ...
    # Keep core database module in sync so the app uses the test DB
    import core.database as core_db
    core_db.DATABASE_URL = database.DATABASE_URL
    core_db.USE_SQLITE = True
